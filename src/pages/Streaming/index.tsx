...
export const Streaming = () => {
  return <div class={css.wrapper}>
    ...
    <p>If you are planning to stream using <a href="https://pon3.stream">pon3.stream</a> or <a href="https://angelthump.com/">AngelThump</a>, your video stream <b>will not be reencoded</b>, so you must stream with a resolution and bitrate that will not overwhelm your viewer's network connection. The following settings in OBS Studio are recommended (feel free to lower the bitrate or resolution if you so desire or if your equipment cannot handle these recommendations): </p>
    <ul>
