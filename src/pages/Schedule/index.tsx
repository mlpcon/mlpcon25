...
export const Schedule = () => {
  ...
  return (
    <div class={css.wrapper}>
      ...
      <div style="text-align: center;">Schedule in <a href="//docs.google.com/spreadsheets/d/1lfSBUSv_TnqY8qJN-gjnwJlRK5t7ZV6VM3xRbFl5VBU/edit?usp=sharing">spreadsheet format available here</a>.</div>
      <div class={css.days}>
        {days.map((day) => (
          <a key={day} href={`#${day}`}>
            {day}
